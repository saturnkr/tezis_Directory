...
update WF_PROC set name = 'Acquaintance', participants_change_enabled = 1, card_types = ',df$SimpleDoc,df$Contract,df$Doc,' where jbpm_process_key = 'Acquaintance' and updated_by is null;
...
--update WF_PROC set name = 'Endorsement (old)', card_types = ',df$SimpleDoc,df$Contract,', combined_stages_enabled = 0 where jbpm_process_key = 'EndorsementFull' and updated_by is null;
update WF_PROC_ROLE set name = 'Get acquainted', role_id = (select id from SEC_ROLE where name = 'doc_acquaintance'), order_filling_type = 'P', is_multi_user = 1 where code = 'Acquaintance' and proc_id = (select id from WF_PROC where jbpm_process_key = 'Acquaintance') and updated_by is null;
...
update WF_PROC_ROLE set name = 'Coordinated', role_id = (select id from SEC_ROLE where name = 'doc_endorsement'), is_multi_user = 1 where code = 'Endorsement' and proc_id = (select id from WF_PROC where jbpm_process_key = 'EndorsementFull') and updated_by is null;
update WF_PROC_ROLE set name = 'Coordinated (p)', role_id = (select id from SEC_ROLE where name = 'doc_endorsement'), is_multi_user = 1 where code = 'EndorsementSeq' and proc_id = (select id from WF_PROC where jbpm_process_key = 'EndorsementFull') and updated_by is null;

update WF_PROC set name = 'Endorsement', card_types = ',df$SimpleDoc,df$Contract,df$Doc,', combined_stages_enabled = 1 where jbpm_process_key = 'Endorsement' and updated_by is null;
...
update WF_PROC_ROLE set name = 'Coordinated', role_id = (select id from SEC_ROLE where name = 'doc_endorsement'), order_filling_type = 'P', is_multi_user = 1 where code = 'Endorsement' and proc_id = (select id from WF_PROC where jbpm_process_key = 'Endorsement') and updated_by is null;

update DF_DOC_KIND set numerator_id = (select top 1 n.id from df_numerator n where n.name = 'Documents and contracts' ) where numerator_id is null;
...
BEGIN
  ...
  DECLARE @cnt integer;
select @cnt =  count(id) from DF_TYPICAL_RESOLUTION where name = 'On approval:';
if(@cnt = 0) begin
insert into DF_TYPICAL_RESOLUTION (id, create_ts, created_by, version, name, text, global)
values (newid(), current_timestamp, USER, 1, 'On approval:', 'On approval:', 1);
end;

select @cnt =  count(id) from DF_TYPICAL_RESOLUTION where name = 'To acquaint:';
if(@cnt = 0) begin
insert into DF_TYPICAL_RESOLUTION (id, create_ts, created_by, version, name, text, global)
values (newid(), current_timestamp, USER, 1, 'To acquaint:', 'To acquaint:', 1);
end;

select @cnt =  count(id) from DF_NUMERATOR where name = 'Incoming (constr.)' and delete_ts is null;
if(@cnt = 0) begin
INSERT INTO DF_NUMERATOR (ID, CREATE_TS, CREATED_BY, VERSION, NAME, NUMERATOR_FORMAT, SCRIPT_ENABLED, PERIODICITY)
VALUES (newid(), current_timestamp, USER, 1, 'Incoming (constr.)', '[departmentCode][number]', 0, 'D');
end;
...
values ('bebc21e2-fce0-40c6-9202-7cffff7cf88e', current_timestamp, USER, 1, 'Incoming',
...
if(@cnt = 0) begin
insert into DF_NUMERATOR (id, create_ts, created_by, version, name, script)
values ('5618547c-a4c9-4bfd-a71e-d884cf49df57', current_timestamp, USER, 1, 'Outgoing',
'def un = com.haulmont.cuba.core.Locator.lookup("cuba_UniqueNumbers")
String numPrefix = "���-"
if(binding.variables.containsKey("doc")) {
com.haulmont.thesis.core.entity.Department department = doc.getDepartment()
...
if(@cnt = 0) begin
insert into DF_NUMERATOR (id, create_ts, created_by, version, name, script)
values ('36708c7f-e232-4451-a239-3f5a8fa10726', current_timestamp, USER, 1, 'Internal',
'def un = com.haulmont.cuba.core.Locator.lookup("cuba_UniqueNumbers")
String numPrefix = ""
if(binding.variables.containsKey("doc")) {
...
values ('9cd678e3-7978-4f53-a503-a36bce3a76d6', 'Contract', 'df$Contract', 0, current_timestamp, USER, 1, 1);
...
if(@cnt = 0) begin
insert into SYS_CATEGORY (ID, NAME, ENTITY_TYPE, IS_DEFAULT, CREATE_TS, CREATED_BY, VERSION, DISCRIMINATOR)
values ('c40ea551-d399-4a11-b6be-347ca5f27837', 'Letter', 'df$SimpleDoc', 0, current_timestamp, USER, 1, 1);
...
if(@cnt = 0) begin
insert into DF_CATEGORY (id, create_ts, created_by, version, doc_type_id, name) values ('56a88e8c-6ab2-427a-97fc-5897005fe8a1', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, '1665ef30-2b44-11df-b1c6-bf8783a93da6', 'Basic');
end;

select @cnt = count(id) from DF_ORGANIZATION where id = 'a851beaf-6890-4ab2-b847-b7a810c4c2b9';
if(@cnt = 0) begin
insert into DF_ORGANIZATION (id, create_ts, created_by, version, name) values ('a851beaf-6890-4ab2-b847-b7a810c4c2b9',{ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Organization');
...
if(@cnt = 0) begin
insert into DF_DOC_RECEIVING_METHOD (id, create_ts, created_by, version, name) values ('ba3e811b-f0dc-4cc8-a119-4e76ff5555b9', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Postal delivery');
end;

select @cnt = count(id) from DF_OFFICE_FILE_NOMENCLATURE where id = '301f91e9-2968-4fc6-ba4e-e3a3ea09d46c';
if(@cnt = 0) begin
insert into DF_OFFICE_FILE_NOMENCLATURE (id, create_ts, created_by, version, name, year, ec_mark, category, organization_id) values ('301f91e9-2968-4fc6-ba4e-e3a3ea09d46c', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Incoming', 2016, 0, 1, 'a851beaf-6890-4ab2-b847-b7a810c4c2b9');
end;

select @cnt = count(id) from DF_OFFICE_FILE_NOMENCLATURE where id = 'd32b5d42-e202-4df5-89ee-9d6111d6d637';
if(@cnt = 0) begin
insert into DF_OFFICE_FILE_NOMENCLATURE (id, create_ts, created_by, version, name, year, ec_mark, category, organization_id) values ('d32b5d42-e202-4df5-89ee-9d6111d6d637', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Outgoing', 2016, 0, 1, 'a851beaf-6890-4ab2-b847-b7a810c4c2b9');
end;

select @cnt = count(id) from DF_OFFICE_FILE_NOMENCLATURE where id = '159ab5b8-fb54-4ea6-a6ba-b485fb885010';
if(@cnt = 0) begin
insert into DF_OFFICE_FILE_NOMENCLATURE (id, create_ts, created_by, version, name, year, ec_mark, category, organization_id) values ('159ab5b8-fb54-4ea6-a6ba-b485fb885010', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Internal', 2016, 0, 1, 'a851beaf-6890-4ab2-b847-b7a810c4c2b9');
end;

select @cnt = count(id) from DF_NUMERATOR where id = 'b3997576-456d-49e8-964a-24a247d4753d';
if(@cnt = 0) begin
insert into DF_NUMERATOR (id, create_ts, created_by, version, name, script) values ('b3997576-456d-49e8-964a-24a247d4753d', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 'Documents and contracts',
'def un = com.haulmont.cuba.core.Locator.lookup("cuba_UniqueNumbers")
String numPrefix = ""
if(binding.variables.containsKey("docOfficeData")) {
com.haulmont.thesis.core.entity.OfficeFile officeFile = docOfficeData.getOfficeFile()
...
if(@cnt = 0) begin
insert into DF_OFFICE_FILE (id, create_ts, created_by, version, volume_no, state, office_file_nomenclature_id, numerator_id, type) values ('a14d4159-c1ec-4b08-8c19-27b77544201b', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 1, 10, '159ab5b8-fb54-4ea6-a6ba-b485fb885010', 'b3997576-456d-49e8-964a-24a247d4753d', 'D');
end;

select @cnt = count(id) from DF_OFFICE_FILE where id = 'e4698cbc-7fdd-4bc7-b011-1d7ccb80ae37';
if(@cnt = 0) begin
insert into DF_OFFICE_FILE (id, create_ts, created_by, version, volume_no, state, office_file_nomenclature_id, numerator_id, type) values ('e4698cbc-7fdd-4bc7-b011-1d7ccb80ae37', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 1, 10, '301f91e9-2968-4fc6-ba4e-e3a3ea09d46c', 'b3997576-456d-49e8-964a-24a247d4753d', 'D');
end;

select @cnt = count(id) from DF_OFFICE_FILE where id = 'fc69f0e9-4b0b-465a-88a6-47805e32e099';
if(@cnt = 0) begin
insert into DF_OFFICE_FILE (id, create_ts, created_by, version, volume_no, state, office_file_nomenclature_id, numerator_id, type) values ('fc69f0e9-4b0b-465a-88a6-47805e32e099', {ts '2010-10-28 00:00:00.00'}, 'admin', 1, 1, 10, 'd32b5d42-e202-4df5-89ee-9d6111d6d637', 'b3997576-456d-49e8-964a-24a247d4753d', 'D');
end;
