...
create table TM_TASK_GROUP (
	...
	constraint FK_TM_TASK_GROUP_SUBSTITUTED_CREATOR foreign key (SUBSTITUTED_CREATOR_ID) references SEC_USER(ID),
...
create table TM_PROJECT_GROUP (
    ...
    ORGANIZATION_ID uniqueidentifier,
    primary key nonclustered (ID),
	constraint FK_TM_PROJECT_GROUP_PROJECT_GROUP foreign key (PARENT_PROJECT_GROUP_ID) references TM_PROJECT_GROUP(ID)
)^
...
create clustered index IDX_TM_TASK_PATTERN_GROUP_TASK_PATTERN_TASK_PATTERN_GROUP on TM_TASK_PATTERN_GROUP_TASK_PATTERN (TASK_PATTERN_GROUP_ID )^
...
create table TM_TASK_VERSION (
    ...
    ORGANIZATION_ID uniqueidentifier,
    primary key nonclustered (CARD_ID),
	constraint FK_TM_TASK_VERSION_CARD foreign key (CARD_ID) references WF_CARD(ID),
	constraint FK_TM_TASK_VERSION_TASK_TYPE foreign key (TASK_TYPE_ID) references TM_TASK_TYPE(CATEGORY_ID),
	constraint FK_TM_TASK_VERSION_PRIORITY foreign key (PRIORITY_ID) references TM_PRIORITY(ID),
	constraint FK_TM_TASK_VERSION_TASK foreign key (TASK_ID) references TM_TASK(CARD_ID)
)^

create clustered index IDX_TM_TASK_VERSION_CREATE_TS on TM_TASK_VERSION (CREATE_TS)^

create index IDX_TM_TASK_VERSION_CARD on TM_TASK_VERSION (CARD_ID)^
...
create table seq_un_task_num (ID bigint identity(1,1), CREATE_TS datetime)^
...
create table DF_CATEGORY (
    ...
    ORGANIZATION_ID uniqueidentifier,
    primary key (ID),
	constraint FK_DF_CATEGORY_DOC_TYPE foreign key (DOC_TYPE_ID) references DF_DOC_TYPE (ID)
)^
...
create table DF_CORRESPONDENT (
    ...
    HAS_ATTACHMENTS tinyint,
    primary key nonclustered (ID),
	constraint FK_DF_CORRESPONDENT_ORGANIZATION foreign key (ORGANIZATION_ID) references DF_ORGANIZATION(ID)
)^
...
create table DF_CONTRACTOR_ACCOUNT (
    ...
    TYPE varchar(1),
    primary key nonclustered (ID),
	constraint FK_DF_CONTRACTOR_ACCOUNT_CONTRACTOR foreign key (CONTRACTOR_ID) references DF_CONTRACTOR (CORRESPONDENT_ID),
	constraint FK_DF_CONTRACTOR_ACCOUNT_CURRENCY foreign key (CURRENCY_ID) references DF_CURRENCY (ID),
	constraint FK_DF_CONTRACTOR_ACCOUNT_BANK foreign key (BANK_ID) references DF_BANK (ID),
	constraint FK_DF_CONTRACTOR_ACCOUNT_DF_BANK foreign key (INDIRECT_CALC_BANK_ID) references DF_BANK (ID)
)^
...
create table DF_ORGANIZATION_ACCOUNT (
    ...
    TYPE varchar(1),
    primary key nonclustered (ID),
	constraint FK_DF_ORGANIZATION_ACCOUNT_CONTRACTOR foreign key (ORGANIZATION_ID) references DF_ORGANIZATION (ID),
	constraint FK_DF_ORGANIZATION_ACCOUNT_CURRENCY foreign key (CURRENCY_ID) references DF_CURRENCY (ID),
	constraint DF_ORGANIZATION_ACCOUNT_BANK foreign key (BANK_ID) references DF_BANK (ID),
	constraint FK_DF_ORGANIZATION_ACCOUNT_DF_BANK foreign key (INDIRECT_CALC_BANK_ID) references DF_BANK (ID)
)^
...
create table DF_OFFICE_FILE_NOMENCLATURE (
    ...
    SUBSTITUTED_CREATOR_ID uniqueidentifier,
    primary key nonclustered (ID),
	constraint FK_DF_OFFICE_FILE_NOMENCLATURE_ORGANIZATION foreign key (ORGANIZATION_ID) references DF_ORGANIZATION(ID),
	constraint FK_DF_OFFICE_FILE_NOMENCLATURE_NOMENCLATURE foreign key (PARENT_NOMENCLATURE_ID) references DF_OFFICE_FILE_NOMENCLATURE(ID),
	constraint FK_DF_OFFICE_FILE_NOMENCLATURE_DEPARTMENT foreign key (DEPARTMENT_ID) references DF_DEPARTMENT (CORRESPONDENT_ID),
	constraint FK_DF_OFFICE_FILE_NOMENCLATURE_TO_SEC_USER foreign key (SUBSTITUTED_CREATOR_ID) references SEC_USER(ID)
)^
...
create clustered index IDX_DF_DOC_CREATE_TS on DF_DOC (CREATE_TS)^
...
INSERT INTO SEC_GROUP (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,name,parent_id) VALUES ('8e6306e2-9e10-414a-b437-24c91ffef804',{ts '2010-02-12 09:47:08.650'},'admin',1,{ts '2010-02-12 09:47:08.650'},null,null,null,'Ограниченный доступ','0fa2b1a5-1d68-4d69-9fbd-dff348347f93')^
INSERT INTO SEC_GROUP (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,name,parent_id) VALUES ('7dfe5c72-073f-4e1e-9cf4-1b1bad9c0093',{ts '2010-06-10 17:08:08.920'},'admin',2,{ts '2010-06-10 17:09:22.520'},'admin',null,null,'Делопроизводители','0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
INSERT INTO SEC_GROUP (id, create_ts, created_by, version, name, parent_id) VALUES ('8d9ba07c-9ffa-11e1-b99d-8fc5b41c7fbb', current_timestamp, USER, 1, 'Руководитель подразделения', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
INSERT INTO SEC_GROUP (id, create_ts, created_by, version, name, parent_id) VALUES ('9fa89a54-9ffa-11e1-b13e-9f4a54bff17e', current_timestamp, USER, 1, 'Руководитель департамента', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
...
VALUES (newid(), current_timestamp, USER, 1, 'tm$Task', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.department.id in (:session$departmentIds) or acl.user.id = :session$userId))', @idPod);
INSERT INTO SEC_CONSTRAINT (id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id)
VALUES (newid(), current_timestamp, USER, 1, 'tm$Task', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.department.id in (:session$departmentIds) or acl.user.id = :session$userId))', @idDep);

INSERT INTO SEC_CONSTRAINT (id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id)
VALUES (newid(), current_timestamp, USER, 1, 'df$Doc', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.department.id in (:session$departmentIds) or acl.global = true))', @idPod);
INSERT INTO SEC_CONSTRAINT (id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id)
VALUES (newid(), current_timestamp, USER, 1, 'df$Doc', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.department.id in (:session$departmentIds) or acl.global = true))', @idDep);

INSERT INTO SEC_CONSTRAINT (id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id)
VALUES (newid(), current_timestamp, USER, 1, 'df$SimpleDoc', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.department.id in (:session$departmentIds) or acl.global = true))', @idPod);
INSERT INTO SEC_CONSTRAINT (id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id)
VALUES (newid(), current_timestamp, USER, 1, 'df$SimpleDoc', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.department.id in (:session$departmentIds) or acl.global = true))', @idDep);

INSERT INTO SEC_CONSTRAINT (id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id)
VALUES (newid(), current_timestamp, USER, 1, 'df$Contract', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.department.id in (:session$departmentIds) or acl.global = true))', @idPod);
INSERT INTO SEC_CONSTRAINT (id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id)
VALUES (newid(), current_timestamp, USER, 1, 'df$Contract', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.department.id in (:session$departmentIds) or acl.global = true))', @idDep);

INSERT INTO SEC_CONSTRAINT (id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id)
VALUES (newid(), current_timestamp, USER, 1, 'tm$TaskGroup', 'left join {E}.taskGroupTasks tgt', '({E}.subCreator.id=:session$userId OR ({E}.global = true AND {E}.template=true)
...
(newid(), current_timestamp, USER, 1, 'df$MeetingDoc', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.department.id in (:session$departmentIds) or acl.global = true))','8d9ba07c-9ffa-11e1-b99d-8fc5b41c7fbb');
INSERT INTO sec_constraint (id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id) VALUES
(newid(), current_timestamp, USER, 1, 'df$MeetingDoc', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.department.id in (:session$departmentIds) or acl.global = true))','9fa89a54-9ffa-11e1-b13e-9f4a54bff17e');


UPDATE SEC_GROUP SET NAME='Полный доступ' where id = '0fa2b1a5-1d68-4d69-9fbd-dff348347f93'^

INSERT INTO sec_group_hierarchy (id,create_ts,created_by,group_id,parent_id,hierarchy_level) VALUES ('4d37ce8d-09fe-419b-9c25-228240750c90',{ts '2010-02-12 09:47:08.650'},'admin','8e6306e2-9e10-414a-b437-24c91ffef804','0fa2b1a5-1d68-4d69-9fbd-dff348347f93',0)^
INSERT INTO sec_group_hierarchy (id,create_ts,created_by,group_id,parent_id,hierarchy_level) VALUES ('f1bd8b8b-92d8-4bb1-9e6e-0187ae57f60c',{ts '2010-06-10 17:08:09.160'},'admin','7dfe5c72-073f-4e1e-9cf4-1b1bad9c0093','0fa2b1a5-1d68-4d69-9fbd-dff348347f93',0);
...
VALUES (newid(), {ts '2010-02-12 09:47:08.650'}, 'admin', @idDep ,'0fa2b1a5-1d68-4d69-9fbd-dff348347f93',0);

INSERT INTO sec_group_hierarchy (id,create_ts,created_by,group_id,parent_id,hierarchy_level)
VALUES (newid(), {ts '2010-02-12 09:47:08.650'}, 'admin', @idPod ,'0fa2b1a5-1d68-4d69-9fbd-dff348347f93',0);
...
VALUES ('18190d06-fc17-482a-8f73-a47df9b97263',{ts '2010-06-08 16:22:33.800'},'admin',3,{ts '2010-06-10 18:42:01.850'},'admin',null,null,'df$SimpleDoc', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))','8e6306e2-9e10-414a-b437-24c91ffef804');
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id)
VALUES ('22581acc-acff-4d58-bc8d-ffaea3dd01fa',{ts '2010-06-08 17:53:02.610'},'admin',2,{ts '2010-06-10 18:41:27.100'},'admin',null,null,'df$Doc', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))','8e6306e2-9e10-414a-b437-24c91ffef804');
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id)
VALUES ('433c5a9a-991f-454c-a064-861a74a66c88',{ts '2010-06-10 17:08:50.220'},'admin',4,{ts '2010-06-10 18:47:20.500'},'admin',null,null,'tm$Task', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where acl.user.id = :session$userId)','7dfe5c72-073f-4e1e-9cf4-1b1bad9c0093');
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id)
VALUES ('7231c87a-2872-4d9a-8167-2f075055f37c',{ts '2010-06-08 16:19:38.700'},'admin',3,{ts '2010-06-10 18:41:49.210'},'admin',null,null,'df$Contract', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))','8e6306e2-9e10-414a-b437-24c91ffef804');
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id)
VALUES ('bcb90482-e02a-42f3-b936-a40b28b5963a',{ts '2010-02-12 09:49:51.740'},'admin',5,{ts '2010-06-10 18:41:40.300'},'admin',null,null,'tm$Task', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where acl.user.id = :session$userId)','8e6306e2-9e10-414a-b437-24c91ffef804');
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id)
VALUES ('cbd897a2-5c4d-4b84-a613-6393c435cbcc',null,'admin',2,{ts '2010-06-10 18:42:09.970'},'admin',null,null,'sec$User',null,'{E}.createdBy is not null','0fa2b1a5-1d68-4d69-9fbd-dff348347f93');
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id)
SELECT 'edda0d21-3aa0-40df-8100-19444d75535c', current_timestamp,'admin', 1,current_timestamp, 'admin',null,null, 'tm$TaskPattern', null,'{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))', '7dfe5c72-073f-4e1e-9cf4-1b1bad9c0093'
FROM sec_group where id = '7dfe5c72-073f-4e1e-9cf4-1b1bad9c0093';
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id)
VALUES ('cb37a982-a1fe-4082-b0ea-440f4211af8d', current_timestamp,'admin', 1,current_timestamp, 'admin',null,null, 'tm$TaskPattern', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))', '8e6306e2-9e10-414a-b437-24c91ffef804');
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id)
VALUES (newid(), current_timestamp,'admin', 1,current_timestamp, 'admin',null,null, 'tm$TaskPattern', null,'{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))', @idDep);
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id)
VALUES (newid(), current_timestamp,'admin', 1,current_timestamp, 'admin',null,null, 'tm$TaskPattern', null,'{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))', @idPod);
...
('589212af-c2cb-ee71-6029-e742d0935ed8',{ts '2010-06-08 16:22:33.800'},'admin',3,{ts '2010-06-10 18:42:01.850'},'admin',null,null,'df$MeetingDoc', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))', '8e6306e2-9e10-414a-b437-24c91ffef804');
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id) VALUES
('9efe6868-855e-e9f0-eca6-6f6c6931633e',{ts '2013-04-03 16:22:33.800'},'admin',3,{ts '2013-04-03 18:42:01.850'},'admin',null,null,'df$MeetingDoc', null,'{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))','9e44a053-a31f-4edd-b19b-39e942161dd2');
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id) VALUES
('9466d7c9-66a2-412b-5579-2be06a97b136',{ts '2010-06-08 16:22:33.800'},'admin',3,{ts '2010-06-10 18:42:01.850'},'admin',null,null,'df$MeetingDoc', null,'{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))','b3dc60f5-65b2-47ab-8802-9e8929bf8b29');


INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id) VALUES ('7b87c520-5c2e-11e0-a770-b3d23ae5dd33',current_timestamp,'admin',1,current_timestamp,'admin',null,null,'tm$TaskGroup','left join {E}.taskGroupTasks tgt left join {E}.participants p',
...
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id)
SELECT '86c0ba0a-5c2e-11e0-b52d-0f8fb8df9d93', current_timestamp,'admin', 1,current_timestamp, 'admin',null,null, 'tm$TaskGroup','left join {E}.taskGroupTasks tgt left join {E}.participants p',
'({E}.subCreator.id = :session$userId
or p.id = :session$userId
or {E}.chairman.id = :session$userId
or {E}.secretary.id = :session$userId
...
INSERT INTO sec_constraint (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id) VALUES ('f79f52d4-d71b-4270-9c3d-72cbc37a32fb',{ts '2013-04-03 16:22:33.800'},'admin',3,{ts '2013-04-03 18:42:01.850'},'admin',null,null,'df$SimpleDoc', null,'{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))','9e44a053-a31f-4edd-b19b-39e942161dd2');
INSERT INTO SEC_CONSTRAINT (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,entity_name,join_clause,where_clause,group_id) VALUES ('99961b6f-d798-479c-9b93-04b16a99ff62',{ts '2013-04-03 17:53:02.610'},'admin',2,{ts '2013-04-03 18:41:27.100'},'admin',null,null,'df$Doc', null,'(TYPE({E}) in (:session$contractEffectiveClass) or {E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true)) and (TYPE({E}) in (:session$simpleDocEffectiveClass) or TYPE({E}) in (:session$meetingDocEffectiveClass)))','9e44a053-a31f-4edd-b19b-39e942161dd2');
...
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value, role_id) VALUES ('9e75c7eb-a430-44f7-8b51-b9f6db4dd90f', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocIncome.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value, role_id) VALUES ('6ed2a5df-8d7c-42ac-8eef-e1bf0edc95a9', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocInternal.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value, role_id) VALUES ('33dd26ac-a1d8-4894-a7b1-5afe0a069773', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$OfficeFileNomenclature.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value, role_id) VALUES ('0db798c7-98ab-41ce-82ce-7eb116953554', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocReceivingMethod.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value, role_id) VALUES ('88d0aa5c-3b84-42c5-b715-ccd24bcf59d8', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocOutcome.browse', 1, '7091f5ef-a77a-450a-834a-39406885676e');
...
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value, role_id) VALUES ('76eaa12b-4d9c-45e6-8265-4e88241d6c8d', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$OfficeFileNomenclature.browse', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
...
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value, role_id) VALUES ('5a8d93b9-c2ac-454d-b88b-16967973a54e', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'df$DocInternal.browse', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
...
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value, role_id) VALUES ('2dc3ec4c-b733-11df-932a-2b8e44e58220', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'jmxConsole', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
...
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value, role_id) VALUES ('e75f3112-aa0c-4bac-8025-e5af579595f8', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, null, null, null, 20, 'df$Doc:delete', 1, '3c9abffb-2fae-484e-990c-343b3c1197ca');
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value, role_id) VALUES ('e889f226-ddeb-4f7a-80fa-5f368ab6aa34', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, null, null, null, 20, 'df$Doc:create', 1, '3c9abffb-2fae-484e-990c-343b3c1197ca');
...
INSERT INTO sec_permission (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, PERMISSION_TYPE, target, value, role_id) VALUES ('b9bf7d7f-8242-4fde-b550-e33d8c0c0545', {ts '2010-05-20 13:04:11.42'}, 'admin', 1, {ts '2010-05-20 13:04:11.42'}, NULL, NULL, NULL, 10, 'systemSettings', 0, '96fa7fe9-397d-4bac-b14a-eec2d94de68c');
...
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('826c59e4-593d-11e0-afdc-87a3d5cee637',null,'admin',1,null,null,null,null,40,'cuba.gui.showInfo',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
---------------------------------------------------------------------------------------------------

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'tm$Project:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

---------------------------------------------------------------------------------------------------

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$DocKind:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$DocKind:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$DocKind:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,'admin',1,10,'sys$Category.browse',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c')^

-----------------------------------------------------------------------------------------------------

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFile:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFile:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFile:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFileNomenclature:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFileNomenclature:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,'admin',1,20,'df$OfficeFileNomenclature:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFileNomenclature:create',1,'7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFileNomenclature:update',1,'7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFileNomenclature:delete',1,'7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFile:create',1,'7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFile:update',1,'7091f5ef-a77a-450a-834a-39406885676e');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$OfficeFile:delete',1,'7091f5ef-a77a-450a-834a-39406885676e');

----------------------------------------------------------------------------------------------------
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:create',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:update',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:delete',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:create',1,'c06c0cee-2f21-4241-8d6f-76b4cd462f96');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:update',1,'c06c0cee-2f21-4241-8d6f-76b4cd462f96');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:delete',1,'c06c0cee-2f21-4241-8d6f-76b4cd462f96');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:create',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:update',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'df$TypicalResolution:delete',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:create',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:update',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,20,'wf$AttachmentType:delete',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');

INSERT INTO sec_permission (id,create_ts,created_by,version,PERMISSION_TYPE,target,value,role_id) VALUES (newid(),current_timestamp,USER,1,10,'df$TypicalResolution.browse',1,'0038f3db-ac9c-4323-83e7-356996cc63ae');
----------------------------------------------------------------------------------------------------
...
INSERT INTO SEC_PERMISSION (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('0c0110cf-75fc-4588-98ab-9b0ea7427f60',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'tm$ScheduleTask.browse',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO SEC_PERMISSION (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('4b498d47-05ce-4bdc-a598-163799386316',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'tm$ScheduleActionType.browse',1,'0c018061-b26f-4de2-a5be-dff348347f93');
INSERT INTO SEC_PERMISSION (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('8be19e1d-973d-4491-9df9-ed30ff785ba9',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'tm$ScheduleActionType.browse',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO SEC_PERMISSION (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('8f402cc1-2540-47cb-9807-2fd56abedee5',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'tm$ScheduleTask.browse',1,'5115e833-4146-4c98-a119-1c06053adb92');
-------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('41fd6ef4-047b-11e1-9dae-b795ca9a4604',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'df$UserSubstitution.browse',1,'b6a03cd4-0479-11e1-b6c9-77dd813b99ee');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('757377c4-0480-11e1-a7ae-df74fc362788',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'df$UserSubstitution.edit',1,'b6a03cd4-0479-11e1-b6c9-77dd813b99ee');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('7a7b4f44-0480-11e1-8d1d-7ff443e73f88',current_timestamp,'admin',1,current_timestamp,null,null,null,20,'sec$UserSubstitution:create',1,'b6a03cd4-0479-11e1-b6c9-77dd813b99ee');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('7f168244-0480-11e1-87ca-b77b6e8c1e4b',current_timestamp,'admin',1,current_timestamp,null,null,null,20,'sec$UserSubstitution:update',1,'b6a03cd4-0479-11e1-b6c9-77dd813b99ee');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('83b055b4-0480-11e1-8afd-978c96b5602f',current_timestamp,'admin',1,current_timestamp,null,null,null,20,'sec$UserSubstitution:delete',1,'b6a03cd4-0479-11e1-b6c9-77dd813b99ee');

INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('8b17059e-045a-11e1-9ff0-5b3f364a9175',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'df$UserSubstitution.browse',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('567d2324-0480-11e1-8725-13795b5a61a9',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'df$UserSubstitution.edit',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');

----------------------------------------------------------------------------------------------------
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('a6935664-885e-11e1-9248-83ef391ff91f',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'printDomain',0,'96fa7fe9-397d-4bac-b14a-eec2d94de68c');
INSERT INTO sec_permission (id,create_ts,created_by,version,update_ts,updated_by,delete_ts,deleted_by,PERMISSION_TYPE,target,value,role_id) VALUES ('83140af2-885f-11e1-9aa3-876f4796e54c',current_timestamp,'admin',1,current_timestamp,null,null,null,10,'printDomain',1,'0c018061-b26f-4de2-a5be-dff348347f93');
...
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('161b69cf-ec53-43b7-bdfb-b60ec8815cb4',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:33:12.160'},'admin',null,2,{t '09:00:00'},{t '13:00:00'});
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('17c2861e-b578-425d-8579-02f6dea3f87b',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:32:26.790'},null,null,5,{t '14:00:00'},{t '18:00:00'});
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('7726565f-daf6-4dfe-858c-f8cf71aef0ce',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:32:26.790'},null,null,5,{t '09:00:00'},{t '13:00:00'});
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('8368e326-689c-4c61-b234-5d35b88a9270',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:32:26.790'},null,null,4,{t '14:00:00'},{t '18:00:00'});
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('868958ec-2b0c-487f-b192-3a2b086d73e3',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:32:26.790'},null,null,4,{t '09:00:00'},{t '13:00:00'});
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('91ac3881-fd81-4e54-a0a5-165d795ccd73',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:32:26.790'},null,null,1,null,null);
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('950e60d9-9f1a-42a3-91e9-5392fa1f8ef9',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:32:26.790'},null,null,6,{t '09:00:00'},{t '13:00:00'});
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('9b64d3ab-1132-4f40-ac2b-bb8df7ec25c6',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:32:26.790'},null,null,3,{t '09:00:00'},{t '13:00:00'});
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('bb8b0b04-fc16-45c3-a377-36044a371014',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:32:26.790'},null,null,6,{t '14:00:00'},{t '18:00:00'});
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('d06a8ef6-8324-4c1f-a022-eb939d048cb3',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:32:26.790'},null,null,7,null,null);
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('d31a2aec-cc9f-464a-8302-e43f8b92a8c5',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:32:26.790'},null,null,3,{t '14:00:00'},{t '18:00:00'});
INSERT INTO wf_calendar (id,create_ts,created_by,update_ts,updated_by,work_day,work_day_of_week,work_start_time,work_end_time) VALUES ('e87c4db4-eb7a-4a35-ace0-29b6bb63095f',{ts '2010-03-03 18:32:26.790'},'admin',{ts '2010-03-03 18:32:26.790'},null,null,2,{t '14:00:00'},{t '18:00:00'});
...
exec create_or_update_sec_permission @r_name='ReferenceEditor', @p_target='df$Department:update', @p_type=20, @p_value=1^
...
insert into SEC_CONSTRAINT (ID, CREATE_TS, CREATED_BY, VERSION, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, ENTITY_NAME, JOIN_CLAUSE, WHERE_CLAUSE, GROUP_ID)
select newid(), current_timestamp, null, 1, null, null, null, null, 'wf$UserGroup', null, '({E}.substitutedCreator.id = :session$userId or {E}.global = true)', ID from SEC_GROUP where ID <> '0fa2b1a5-1d68-4d69-9fbd-dff348347f93'
^
...
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='userMobileBrowse', @p_type=10, @p_value=0^
exec create_or_update_sec_permission @r_name='Administrators', @p_target='userMobileBrowse', @p_type=10, @p_value=1^
...
insert into SYS_CONFIG(id, create_ts, created_by, version, name, value) values
('2e7792fe-2ccb-11e3-9489-8b3b585569ea', current_timestamp, 'admin', 1, 'thesis.firstInstallationThesisVersion', '3.6')^
...
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:position', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:password', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:organization', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:ipMask', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:name', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:login', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:firstName', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:middleName', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:lastName', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:changePasswordAtNextLogon', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:email', @p_type=30, @p_value=2^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:active', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:language', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:departmentCode', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:group', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:isMobile', @p_type=30, @p_value=1^
exec create_or_update_sec_permission @r_name='SimpleUser', @p_target='sec$User:activeDirectoryID', @p_type=30, @p_value=1^
...
insert into sec_constraint(id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id) values
('bc94a0d4-10ca-11e4-8fb1-07511252f87c', current_timestamp, 'system', 1, 'df$Doc', null, '({E}.docOfficeData.officeFile.state >= 30 and {E}.template = false or {E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true)))', 'cff945e4-e363-0dc0-d70d-4b5bdb2a2269');

insert into sec_constraint(id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id) values
('bfb52f2c-10ca-11e4-bf3e-934403a7308f', current_timestamp, 'system', 1, 'df$SimpleDoc', null, '({E}.docOfficeData.officeFile.state >= 30 and {E}.template = false or {E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true)))', 'cff945e4-e363-0dc0-d70d-4b5bdb2a2269');

insert into sec_constraint(id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id) values
('c2292574-10ca-11e4-857e-bb6e9cc79bd5', current_timestamp, 'system', 1, 'df$Contract', null, '({E}.docOfficeData.officeFile.state >= 30 and {E}.template = false or {E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true)))', 'cff945e4-e363-0dc0-d70d-4b5bdb2a2269');

insert into sec_constraint(id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id) values
('c42e9fa2-10ca-11e4-9c89-8758c81c5f95', current_timestamp, 'system', 1, 'tm$Task', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where acl.user.id = :session$userId)', 'cff945e4-e363-0dc0-d70d-4b5bdb2a2269');

insert into sec_constraint(id, create_ts, created_by, version, entity_name, join_clause, where_clause, group_id) values
('c646b7e8-10ca-11e4-9ac6-5b5381a1ae07', current_timestamp, 'system', 1, 'tm$TaskPattern', null, '{E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true))', 'cff945e4-e363-0dc0-d70d-4b5bdb2a2269');
...
INSERT INTO sec_constraint (id,create_ts,created_by,version,entity_name,join_clause,where_clause,group_id) VALUES
('ce84d65b-6f47-c896-d393-bf3dab98660d', current_timestamp, 'system', 1, 'df$MeetingDoc', null, '({E}.docOfficeData.officeFile.state >= 30 and {E}.template = false or {E}.id in (select acl.card.id from ts$CardAcl acl where (acl.user.id = :session$userId or acl.global = true)))', 'cff945e4-e363-0dc0-d70d-4b5bdb2a2269');
