...
update WF_PROC_ROLE set name = 'Инициатор', role_id = (select id from SEC_ROLE where name = 'task_initiator'),assign_to_creator = 1 where code = '10-Initiator' and proc_id = (select id from WF_PROC where jbpm_process_key = 'TaskManagement') and updated_by is null;
update WF_PROC_ROLE set name = 'Исполнитель', role_id = (select id from SEC_ROLE where name = 'task_executor'), order_filling_type = 'P', is_multi_user = 1 where code = '20-Executor' and proc_id = (select id from WF_PROC where jbpm_process_key = 'TaskManagement') and updated_by is null;
...
update WF_PROC_ROLE set name = 'Наблюдатель', role_id = (select id from SEC_ROLE where name = 'task_observer'), order_filling_type = 'P', is_multi_user = 1 where code = '90-Observer' and proc_id = (select id from WF_PROC where jbpm_process_key = 'TaskManagement') and updated_by is null;
...
if(@cnt = 0) begin
insert into SYS_CONFIG (id, create_ts, created_by, version, name, value) values ('f6a9be40-16ac-11e2-8783-7b7ddae9940d', current_timestamp, 'admin', 1, 'workflow.sms.smsProviderClassName', 'com.haulmont.thesis.core.app.SmsTrafficProvider');
end;
